 ...
 ********************************************************************************/
package org.eclipse.glsp.integration.editor.clipboard.ui;
...
public class JsonTransfer extends ByteArrayTransfer {
   ...
   @Override
   protected String[] getTypeNames() { return new String[] { APPLICATION_JSON }; }

   @Override
   protected int[] getTypeIds() { return new int[] { JSON_TYPE_ID }; }
