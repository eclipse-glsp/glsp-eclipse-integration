 ...
 ********************************************************************************/
import { Action, configureActionHandler, IActionHandler, ILogger, TYPES } from "@eclipse-glsp/client";
...
export const keepAliveModule = new ContainerModule((bind, _unbind, isBound) => {
